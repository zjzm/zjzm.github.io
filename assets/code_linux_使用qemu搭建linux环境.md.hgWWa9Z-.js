import{_ as s,c as i,o as a,a4 as n}from"./chunks/framework.qL1yNBZ5.js";const e="/assets/5708e3a58c4f4de9b3253941a725f346.FAXsB9Aa.png",p="/assets/a53300b37805446b80822251feced3c3.CDLoMzDc.png",l="/assets/06b2a02b00074e62a532628788f12aee.BSCqcmg8.png",m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"code/linux/使用qemu搭建linux环境.md","filePath":"code/linux/使用qemu搭建linux环境.md"}'),t={name:"code/linux/使用qemu搭建linux环境.md"},h=n('<h2 id="qemu" tabindex="-1">qemu <a class="header-anchor" href="#qemu" aria-label="Permalink to &quot;qemu&quot;">​</a></h2><p>QEMU（Quick EMUlator）是一款开源的虚拟化软件，能够模拟多种硬件平台，并支持多种虚拟化技术，如 KVM（Kernel-based Virtual Machine）加速。QEMU 能够在多个操作系统上运行，包括 Windows、Linux 和 macOS。</p><ol><li>下载 QEMU： 访问 QEMU 官方网站或通过包管理器下载适用于 Windows 的 QEMU 版本。</li></ol><p>官网地址:<a href="https://www.qemu.org/?spm=a2c6h.12873639.article-detail.4.b56d1783Rqc5sS" target="_blank" rel="noreferrer">https://www.qemu.org/</a></p><ol><li>安装 QEMU： 解压下载的文件到您选择的目录，并确保路径添加到系统的环境变量中。(配置好变量路径方便,手动进入路径也可)</li><li>准备好一个x86的镜像或者img的镜像，格式可以为qcow2</li></ol><p>QEMU 支持多种磁盘映像格式，包括 raw、qcow2、qed、vdi、vhd、vmdk、cow、parallels 和 dmg 等。</p><p>QEMU_EFI.fd文件下载地址： <a href="http://releases.linaro.org/components/kernel/uefi-linaro/16.02/release/qemu64/" target="_blank" rel="noreferrer">http://releases.linaro.org/components/kernel/uefi-linaro/16.02/release/qemu64/</a></p><p>centos:</p><p><a href="https://archive.kernel.org/centos-vault/altarch/" target="_blank" rel="noreferrer">Index of /centos-vault/altarch/</a></p><p>阿里云centos:</p><p><a href="https://mirrors.aliyun.com/centos-vault/altarch" target="_blank" rel="noreferrer">https://mirrors.aliyun.com/centos-vault/altarch</a></p><h3 id="安装虚拟网卡" tabindex="-1">安装虚拟网卡 <a class="header-anchor" href="#安装虚拟网卡" aria-label="Permalink to &quot;安装虚拟网卡&quot;">​</a></h3><p><a href="../../public/linux/tap-windows_XQYHn-1.exe">当时使用下载到的</a></p><p>这里我们选择openvpn</p><p>官方地址:<a href="https://swupdate.openvpn.net/downloads/connect/openvpn-connect-3.3.6.2752_signed.msi?spm=a2c6h.12873639.article-detail.5.b56d1783Rqc5sS&amp;file=openvpn-connect-3.3.6.2752_signed.msi" target="_blank" rel="noreferrer">https://swupdate.openvpn.net/downloads/connect/openvpn-connect-3.3.6.2752_signed.msi</a></p><p>双击下载下来的openvpn-connect-3.3.6.2752_signed.msi软件，和安装其它软件一样，一步步安装即可。</p><p>注意：不一定非得安装这个软件，能创建虚拟网卡就行如win+R &quot;hdwwiz&quot;添加硬件,找到合适的网卡我个人觉得理论可行(此法慎用,当时我安装后电脑提示过时硬件一直引导不进系统修了一下午电脑)</p><p><img src="'+e+'" alt="image"></p><p>红框内所示的网卡是新添加的,安装完 OpenVPN 后名称可能会有所不同只需关注小红框中的网卡类型是否为“TAP-Windows Adapter”，找到这种类型的网卡即可确认这是新添加的网卡。此时，该网卡的连接状态会显示为未连接状态，无需担心，启动虚拟机后连接状态会变为正常。</p><p>这里修改为了tap0，其它的名称也可以，建议还是修改为tapXX这种形式，最好不要用中文名称。</p><p><img src="'+p+'" alt="image"></p><p>再选择你需要桥接到的网卡创建新网卡的网桥</p><p><img src="'+l+`" alt="image"></p><h3 id="创建linux-bat文件" tabindex="-1">创建linux bat文件 <a class="header-anchor" href="#创建linux-bat文件" aria-label="Permalink to &quot;创建linux bat文件&quot;">​</a></h3><div class="language-bat vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bat</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">%创建硬盘文件%</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">-net nic,model=virtio </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">^</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">-net tap,ifname=tap0 </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">^</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">-boot d D:\\qemu\\centos7\\centos7.9-aarch64.qcow2</span></span></code></pre></div>`,27),k=[h];function E(r,c,d,o,g,y){return a(),i("div",null,k)}const F=s(t,[["render",E]]);export{m as __pageData,F as default};
