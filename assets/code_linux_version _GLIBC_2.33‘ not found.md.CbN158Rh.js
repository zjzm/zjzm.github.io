import{_ as s,c as a,o as i,a4 as n}from"./chunks/framework.qL1yNBZ5.js";const l="/assets/image-20241030092710528.xiwQXh4Q.png",B=JSON.parse('{"title":"centos","description":"","frontmatter":{},"headers":[],"relativePath":"code/linux/version `GLIBC_2.33‘ not found.md","filePath":"code/linux/version `GLIBC_2.33‘ not found.md"}'),p={name:"code/linux/version `GLIBC_2.33‘ not found.md"},t=n('<div class="note custom-block github-alert"><p class="custom-block-title">NOTE</p><p></p><p>这是在C和C++编译php扩展时遇到了问题,编译完成之后在其他服务器系统里无法运行的情况</p></div><p><img src="'+l+`" alt="image-20241030092710528"></p><h1 id="centos" tabindex="-1">centos <a class="header-anchor" href="#centos" aria-label="Permalink to &quot;centos&quot;">​</a></h1><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#用strings命令查看下系统中的GLIBC版本</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">GLIBC_PRIVATE</span></span></code></pre></div>`,8),e=[t];function h(k,c,d,r,o,C){return i(),a("div",null,e)}const g=s(p,[["render",h]]);export{B as __pageData,g as default};
